...
extends Thread
{
    ...
    public Niche(Environment e)
    {
        ...
        folks =
             ...
             * so that I can make insretions and deletions into 
...
//             )
    ...
    public void run() 
    {
        ...
        while(!done) {
            /*
             * Only works in Java 1.6 
             * (i.e., not in a Mac browser as of 2009-01-19)
             */
//             Individual lowest = folks.pollFirstEntry().getValue();
            step();
            cycles++;
        }
    }
